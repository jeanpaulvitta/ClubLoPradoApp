...
// ==================== DEMO USERS ====================
// Base de datos simulada de usuarios para demostración
const DEMO_USERS = [
  {
    id: 'user_admin_1',
    email: 'admin@loprado.cl',
    password: 'admin123',
    name: 'Administrador Lo Prado',
    role: 'admin' as const,
  },
  {
    id: 'user_coach_1',
    email: 'coach@loprado.cl',
    password: 'coach123',
...
export function debugClearRegisteredUsers() {
  ...
  console.log('ℹ️ Los usuarios demo (admin@loprado.cl, coach@loprado.cl, nadador@loprado.cl) NO se eliminan porque son parte del código del sistema');
  localStorage.removeItem(REGISTERED_USERS_KEY);
  console.log('✅ Usuarios registrados eliminados correctamente');
  console.log('💡 Los usuarios demo seguirán disponibles para iniciar sesión');
}