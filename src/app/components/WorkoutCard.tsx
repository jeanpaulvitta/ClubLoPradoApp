...
import { Waves, Clock, Ruler, Download, Users } from "lucide-react";
...
export function WorkoutCard({
  ...
  const getGroupColor = (group?: 1 | 2 | "Ambos") => {
    if (group === 1) return "bg-purple-100 text-purple-700";
    if (group === 2) return "bg-green-100 text-green-700";
    return "bg-gray-100 text-gray-700";
  };

  const getGroupLabel = (group?: 1 | 2 | "Ambos") => {
    if (group === 1) return "👶 Grupo 1";
    if (group === 2) return "🏅 Grupo 2";
    return "🏊 Todos";
  };
